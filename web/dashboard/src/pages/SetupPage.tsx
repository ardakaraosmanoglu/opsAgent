      ...
      <div className="w-full max-w-sm animate-fade-in">
        ...
        <Card className="border-border/60 shadow-lg shadow-black/20">
          <CardHeader className="space-y-1 pb-4">
            <CardTitle className="text-lg font-semibold">Initial Setup</CardTitle>
            <CardDescription className="text-xs">Create your admin account to get started</CardDescription>
          </CardHeader>
          <CardContent>
